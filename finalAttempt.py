...
# every board position has 1 of 6 colors
...
flattened_constr = [item for sublist in first_position_constraints for item in sublist] #combine the consition so we can add it later
